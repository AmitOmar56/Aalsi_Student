...
public class CourseScreen_2Activity extends AppCompatActivity implements CoursesAdapter.OnItemClicked {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_screen_2);
...
//        actionBar.setIcon(R.drawable.profile);
    ...
    private void getdatafromIntent() {
        if (getIntent() != null) {
            cat_Id = Integer.parseInt(getIntent().getStringExtra("id"));
            Log.d("cat_Id", cat_Id + "");
        }
    }
        ...
        StringRequest postRequest = new StringRequest(Request.Method.GET, "http://aalsistudent.com/admin_panel/users/sub_category.php",
                ...
                new com.android.volley.Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CourseScreen_2Activity.this, "Network Error", Toast.LENGTH_LONG).show();
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(this, TeacherScreenActivity.class);
